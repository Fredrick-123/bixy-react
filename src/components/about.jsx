...
import Myuniverse from '../assets/Myuniverse.svg'
        ...
        <div className='md:px-14 p-4 max-w-s mx-auto space-y-6' id='about'>
            <div className='flex flex-col md:flex-row  justify-between items-center gap-8'>
                ...
                <motion.div variants={FadeIn("right" ,0.2)} initial="hidden" whileInView={"show"} viewport={{once: false , amount: 0.7}} className='md:w-1/2'>
                    <img src={Readingtime} alt="readingtime" />
                </motion.div>

                {/*About content*/}
                <motion.div variants={FadeIn("left" ,0.3)} initial="hidden" whileInView={"show"} viewport={{once: false , amount: 0.7}}  className='md:w-2/4 '>
                    ...
                    <p className='text-tertiary text-lg mb-7 '>A good example of a paragraph contains a topic conclusion.
...
<motion.div variants={FadeIn("up" ,0.2)} initial="hidden" whileInView={"show"} viewport={{once: false , amount: 0.7}} className='md:w-1/2'>
    <img src={Myuniverse} alt="MyUniverse" />
</motion.div>

{/*About content*/}
<motion.div variants={FadeIn("right" ,0.2)} initial="hidden" whileInView={"show"} viewport={{once: false , amount: 0.7}} className='md:w-2/4 '>
